...
$Query = "SELECT @row := @row + 1 AS commentNumber, commentTimeOnProgressBar, comment, commentImage, createdBy, commentOffset, commentVideo,
case 
...
while( $Row = mysql_fetch_object( $Result ) )
{
   ...
   print "<Items><Number>".$Row->commentNumber."</Number>
				...
				<CommentVideo>".$Row->commentVideo."</CommentVideo>
				<DisplayType>".$Row->DisplayType."</DisplayType>
				</Items>\n";
}
print "</comment>";
?>